...
from tensorflow.keras.layers import Dense, Embedding, LSTM, Input      # Embedding 은 원핫인코더 안 한 상태에서 들어감     # Embedding : 원핫인코더&벡터화 한번에 해줌
...
# 실습, 함수로 고쳐라!!!
input = Input(shape=(5,))
emb = Embedding(input_dim=28, output_dim=77, input_length=5)(input)
emb = LSTM(32)(emb)
