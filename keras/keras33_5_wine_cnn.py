...
x_train = x_train.reshape(4873, 11, 1, 1)
x_test = x_test.reshape(25, 11, 1 ,1)
...
model = Sequential()
model.add(Conv2D(240, kernel_size=(1,1), activation='relu', input_shape=(11,1,1)))
model.add(Conv2D(240, (1,1), activation='relu'))
model.add(MaxPool2D())
