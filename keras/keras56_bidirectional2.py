...
from tensorflow.keras.layers import Dense, Embedding, LSTM, Bidirectional      # Embedding 은 원핫인코더 안 한 상태에서 들어감     # Embedding : 원핫인코더&벡터화 한번에 해줌
...
_________________________________________________________________
bidirectional (Bidirectional (None, 64)                28160        # LSTM X 2 = Bidirectional
_________________________________________________________________
dense (Dense)                (None, 1)                 65
=================================================================
Total params: 30,381
Trainable params: 30,381
Non-trainable params: 0
_________________________________________________________________
'''
