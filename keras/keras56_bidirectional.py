...
### 양방향LSTM(layer wrapping) - Bidirectional 사용 : 성능 장담 못함
...
model.add(Bidirectional(LSTM(units=10, activation='relu', input_shape=(3, 1))))     # LSTM이 선행되어야 Bidirectional 사용할 수 있음
...
_________________________________________________________________
bidirectional (Bidirectional (None, 20)                1680         # LSTM X 2 = Bidirectional(양방향)
_________________________________________________________________
