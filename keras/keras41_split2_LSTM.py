...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.7, shuffle=False, random_state=9)
...
ic(x_train.shape, x_test.shape)   # x_train.shape: (66, 5), x_test.shape: (29, 5)
x_train = x_train.reshape(66, 5, 1)
...
model.fit(x_train, y_train, validation_split=0.1, epochs=1000, batch_size=5, callbacks=[es])
