...
model = load_model('./_save/pred_stock_model_save9.h5')
...
#             save_best_only=True, 
#             filepath= './_save/ModelCheckPoint/pred_stock_MCP9.py')

# model.fit([sam_x_train, sk_x_train], sam_y_train, epochs=150, batch_size=50, validation_split=0.02, callbacks=[es, cp])


# model.save('./_save/pred_stock_model_save9.h5')
# model.save_weights('./_save/pred_stock_weight_save9.h5')
