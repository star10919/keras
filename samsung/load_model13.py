...
# conv = Conv1D(126, 3, activation='relu')(lstm)
# # conv = MaxPool1D()(conv)
# # conv = Dropout(0.2)(conv)
# flat = Flatten()(conv)
...
model = load_model('./_save/pred_stock_model_save13.h5')
...
#             save_best_only=True, 
#             filepath= './_save/ModelCheckPoint/pred_stock_MCP13.py')

# model.fit([sam_x_train, sk_x_train], sam_y_train, epochs=150, batch_size=50, validation_split=0.02, callbacks=[es, cp])


# model.save('./_save/pred_stock_model_save13.h5')
# model.save_weights('./_save/pred_stock_weight_save13.h5')
