...
# lstm = LSTM(15, activation='relu', return_sequences=True)(input1)
...
# lstm = LSTM(15, activation='relu', return_sequences=True)(input2)
# conv = Conv1D(64, 2, activation='relu')(lstm)
# # conv = Dropout(0.2)(conv)
# flat = Flatten()(conv)
...
model= load_model('./_save/pred_stock_model_save5.h5')
...
#             save_best_only=True, 
#             filepath= './_save/ModelCheckPoint/pred_stock_MCP5.py')

# model.fit([sam_x_train, sk_x_train], sam_y_train, epochs=50, batch_size=50, validation_split=0.02, callbacks=[es, cp])


# model.save('./_save/pred_stock_model_save5.h5')
# model.save_weights('./_save/pred_stock_weight_save5.h5')
