...
# model = load_model('./_save/pred_stock_model_save11.h5')
...
model.load_weights('./_save/pred_stock_weight_save11.h5')
...
# model.save_weights('./_save/pred_stock_weight_save11.h5')
